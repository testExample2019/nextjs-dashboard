      ...
      >
        ...
        <ButtonDropdown
          children={
            <button
              type="button"
              className={`inline-flex w-full justify-center gap-x-1.5 rounded bg-white px-3 py-2 text-sm capitalize font-semibold text-action-primary outline-1 shadow-sm border border-action-primary  hover:bg-gray-50`}
              id="menu-button"
              aria-haspopup="true"
            >
              {"Add Deal"}

...
const LoanTemplatePage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start">
      <div className="max-w-4xl w-full px-8 py-32 rounded-lg">
        ...
        <p className="mt-2 text-grey text-center">
          We will prepopulate most of the fields to simplify the loan
          onboarding.
        </p>
        <div id="tour1-step2" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-6">
          {templates.map((template, index) => (
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <hr className="h-px my-4 bg-[#6B98A2] border-0 w-[30px] mx-auto" />
                <h3 className="text-18 font-semibold text-grey-primary">
                  {template.title}
                </h3>
                <p className="mt-2 text-xs text-grey">{template.description}</p>
              </div>
            </button>
          ))}
        </div>

        ...
        >
          ...
          <div className="flex justify-between py-2 px-6 gap-4 border-t-1 border-grey-border">
            <button
              ...
              className="cursor-pointer px-4 py-2 uppercase text-action-primary rounded-sm hover:bg-gray-100 font-semibold"
            >
              Cancel
            </button>
            <button
              onClick={() => redirect(defaultDashboardPath)}
              className="cursor-pointer px-4 py-2 uppercase bg-action-primary text-white rounded-sm hover:bg-blue-dark font-semibold"
            >
              Save
            </button>
          </div>

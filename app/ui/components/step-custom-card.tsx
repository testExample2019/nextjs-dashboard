        ...
        {step.showControls && (
          <div className="flex justify-between gap-2">
            <button
              ...
              className={`bg-white border text-sm border-grey-border capitalize text-grey-primary px-4 py-2 rounded-md font-semibold w-full max-w-52 ${currentStep === 0 ? "opacity-50" : "opacity-100"}`}
            >
              Previous
            </button>
            <button
              onClick={nextStep}
              className="bg-action-primary text-sm text-white capitalize px-4 py-2 rounded-md font-semibold w-full max-w-52"
            >

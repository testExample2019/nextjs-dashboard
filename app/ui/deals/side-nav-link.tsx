...
export const SideNavLink = ({
  ...
  return (
    <Link
      className={`${path.includes(slug) ? "bg-blue-o" : "bg-white"} ${slug === deals[0].slug ? "" : "pointer-events-none"} w-full max-w-sm  border rounded-lg shadow-md p-2 block transition-all hover:shadow-lg`}
      href={href}
    >
      ...
      <div className="mt-2">
        <div className="w-full rounded-full h-2.5 bg-(--bg-grey-o)">
